...
//		/* Enable time update */
		...
		if (Timer_1_En==1)
			if (Timer_1_Count<359999) Timer_1_Count++; else Timer_1_Count=0;
		if (Timer_2_En==1) 
			if (Timer_2_Count<359999) Timer_2_Count++;else Timer_2_Count=0;
